...
Фреймворк создан в целях обучения, но предлагает некоторые продвинутые опции, такие как гибкая [система роутинга](#система-роутинга) и [экшен-фильтры](#система-роутинга).
...
В приложении реализованы: система авторизации/аутентификации, рассылка уведомлений на почту, хранение данных (локально и на базе AWS S3), восстановление пароля, защита от спама, работа с хэштегами, админ-панель и другой функционал.
