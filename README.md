...
В [myPosts](https://github.com/IlyaMur/myposts_app) реализованы: система авторизации/аутентификации, рассылка уведомлений на почту, хранение данных (локально и на базе AWS S3), восстановление пароля, защита от спама, работа с хэштегами, админ-панель и другой функционал.
